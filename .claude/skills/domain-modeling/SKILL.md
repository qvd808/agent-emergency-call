...
In this repo the glossary is `GLOSSARY.md`, not the upstream skill's `CONTEXT.md`: the root
`CONTEXT.md` is the project brief (scope, safety rules, issue list). It is local-only and
gitignored, and this skill never edits it.
