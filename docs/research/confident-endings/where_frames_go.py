...
VOWELS = set("aeiouæɑɒɔəɛɜɪʊʌɐɚɝɵʉyøœɤɯɨː")
PUNCT = set(",.;:!?")
...
for text in LINES.values():
    for phonemes in hfc.phonemize(text):
        ...
        for k, sym in enumerate(symbols):
            if sym == "_":
                pass  # a PAD keeps the class of the id before it
            elif sym == "^":
                cls = "lead-in"
...
for cls in ["lead-in", "vowels", "consonants", "word end", "spaces/stress", "pause marks"]:
    t = totals[cls]
